...
(cl:in-package keyboard_input-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ctrl_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ctrl_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name keyboard_input-msg:<ctrl_cmd> is deprecated: use keyboard_input-msg:ctrl_cmd instead.")))

(cl:ensure-generic-function 'steer-val :lambda-list '(m))
(cl:defmethod steer-val ((m <ctrl_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader keyboard_input-msg:steer-val is deprecated.  Use keyboard_input-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <ctrl_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader keyboard_input-msg:throttle-val is deprecated.  Use keyboard_input-msg:throttle instead.")
  (throttle m))

...
if("TRUE" STREQUAL "TRUE")
  set(pca9685_msgs_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ros_pca9685/pca9685_msgs)
...
if(NOT "/home/ubuntu/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dennn66 <dennn@e1.ru>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pca9685_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'pca9685_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ros_pca9685/pca9685_msgs/${idir}'.  ${_report}")
    endif()
...
set(pca9685_msgs_EXPORTED_TARGETS "pca9685_msgs_generate_messages_cpp;pca9685_msgs_generate_messages_eus;pca9685_msgs_generate_messages_lisp;pca9685_msgs_generate_messages_nodejs;pca9685_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pca9685_msgs_dep}_FOUND)
      find_package(${pca9685_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pca9685_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
